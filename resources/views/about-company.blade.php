                                                   ...
                                                   <div class="tab-content">
                                                       <div id="about-me" class="tab-pane fade active show">
                                                           <div class="profile-personal-info pt-4">
                                                               ...
                                                               <div class="row mb-4">
                                                                   ...
                                                                   <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                                       @if ($company->status == 'Active')
                                                                            ...
                                                                            <span class="btn btn-success">{{ $company->status }}</span>
                                                                            
                                                                        @else

                                                                            <span class="btn btn-danger">{{ $company->status }}</span>
                                                               ...
                                                               <div class="row mb-4">
                                                                   <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                                       <h5 class="f-w-500">Company Description <span class="pull-right">:</span></h5>
                                                                   </div>
                                                                   <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                                        <p>
                                                                            {{ $company->desc }}
