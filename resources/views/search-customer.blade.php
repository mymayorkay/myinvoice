                                             ...
                                             <form action="">
                                                    ...
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                           ...
                                                           <div class="form-group">
                                                            ...
                                                            <select class="form-control form-control-lg" name="q" id="query">
                                                ...
                                                @if(!empty($data))
                                                  ...
                                                  @foreach($data as $d)
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td>{{ $d->phone }}</td>
                                                        <td>{{ $d->address }}</td>
                                                        <td>{{ $d->amount1 + $d->amount2 + $d->amount3 + $d->amount4 + $d->amount5 + $d->amount6 }}</td>                                                            
                                                        <td>
                                                            @if ($d->status == 'Paid')
                                                            <a href="javascript:void()" class="btn btn-sm w3-green">{{ $d->status }}</a>
                                                            @else
                                                            <a href="javascript:void()" class="btn btn-sm w3-red">{{ $d->status }}</a>
                                                            @endif
                                                        </td>                                              
                                                    </tr>
